...
- [x] **TUTOR-01**: User sees a Personal Tutor tab (4th tab) on the study page alongside Notes, Flashcards, and Quiz
...
- [x] **TUTOR-04**: Tutor introduces itself and its capabilities when user first opens the tab
...
|-------------|-------|--------|
| TUTOR-01 | Phase 16 | Complete |
| TUTOR-02 | Phase 14 | Complete |
| TUTOR-03 | Phase 14 | Complete |
| TUTOR-04 | Phase 16 | Complete |
